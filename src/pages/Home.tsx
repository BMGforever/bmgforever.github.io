...
<div className="min-h-screen bg-[#f9fafb] flex flex-col items-center justify-center p-6">
      ...
      <div className="max-w-2xl text-center mb-12">
        ...
        <p className="text-[#334155] text-lg">
          Ich tue mich schwer, ein gutes Problem für ein Startup zu finden, also habe ich diese Seite gebaut, um gezielt darin besser zu werden.  
          Hier sammle, analysiere und lerne ich – strukturiert mit Lean Canvas und täglichen Challenges.
        </p>
      </div>
      ...
      <div className="w-full max-w-4xl mb-16">
        <div className="bg-white border-l-4 border-blue-500 rounded-2xl shadow-md p-6 md:p-8 text-[#475569]">
          ...
          <p className="leading-relaxed mb-4">
            ...
            zeige es jemandem, lerne daraus – und mache weiter. Ohne Drama, ohne Perfektion.
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-[#1e293b] mb-2">Lean Canvas ausfüllen</h2>
          <p className="text-[#475569]">
            Entwickle strukturiert Geschäftsmodelle mit dem Lean Canvas. Exportiere dein Modell als PDF.
          </p>
        </Link>
        ...
        >
          ...
          <h2 className="text-xl font-semibold text-[#1e293b] mb-2">Tägliche Startup-Analyse</h2>
          <p className="text-[#475569]">
            Untersuche täglich ein Startup: Warum hat es funktioniert – und warum vorher nicht?
          </p>
        </Link>
      </div>
